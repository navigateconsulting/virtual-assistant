...
var iosTransitionAnimation = function () { return import('./ios.transition-bdc3a806.js'); };
var mdTransitionAnimation = function () { return import('./md.transition-3ed08426.js'); };
...
var animation = function (animationBuilder, opts) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, import('./index-d3aa5dba.js').then(function (mod) { return mod.create(animationBuilder, opts.baseEl, opts); })];
            case 2:
                trans = _a.sent();
