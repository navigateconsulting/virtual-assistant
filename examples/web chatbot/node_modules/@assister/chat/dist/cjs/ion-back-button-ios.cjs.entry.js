...
class BackButton {
    constructor(hostRef) {
        ...
        this.onClick = async (ev) => {
            ...
            return __chunk_3.openURL(this.defaultHref, ev, 'back');
        };
    }
    get backButtonIcon() {
        return this.icon != null ? this.icon : __chunk_1.config.get('backButtonIcon', 'arrow-back');
    }
    get backButtonText() {
        const defaultBackButtonText = this.mode === 'ios' ? 'Back' : null;
        return this.text != null ? this.text : __chunk_1.config.get('backButtonText', defaultBackButtonText);
    }
    get hasIconOnly() {
