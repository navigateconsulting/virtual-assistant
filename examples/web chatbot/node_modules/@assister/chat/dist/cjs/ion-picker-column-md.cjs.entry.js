...
const __chunk_9 = require('./chunk-57fc11a5.js');
...
class PickerColumnCmp {
    ...
    onEnd(detail) {
        ...
        this.velocity = __chunk_2.clamp(-MAX_PICKER_SPEED, detail.velocityY * 23, MAX_PICKER_SPEED);
    ...
    refresh(forceRefresh) {
        ...
        const selectedIndex = __chunk_2.clamp(min, this.col.selectedIndex || 0, max);
