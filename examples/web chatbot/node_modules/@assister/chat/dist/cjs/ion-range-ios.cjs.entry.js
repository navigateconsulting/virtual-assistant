...
class Range {
    constructor(hostRef) {
        ...
        this.clampBounds = (value) => {
            return __chunk_2.clamp(this.min, value, this.max);
        };
        ...
        this.handleKeyboard = (knob, isIncrease) => {
            ...
            if (knob === 'A') {
                this.ratioA = __chunk_2.clamp(0, this.ratioA + step, 1);
            }
            else {
                this.ratioB = __chunk_2.clamp(0, this.ratioB + step, 1);
            }
            this.updateValue();
        };
        this.onBlur = () => {
    ...
    onStart(detail) {
        ...
        let ratio = __chunk_2.clamp(0, (currentX - rect.left) / rect.width, 1);
        if (document.dir === 'rtl') {
            ratio = 1 - ratio;
        }
        this.pressedKnob =
...
const ratioToValue = (ratio, min, max, step) => {
    ...
    return __chunk_2.clamp(min, value, max);
};
const valueToRatio = (value, min, max) => {
    return __chunk_2.clamp(0, (value - min) / (max - min), 1);
};
